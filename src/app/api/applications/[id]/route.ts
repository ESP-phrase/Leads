  ...
  if (action === 'reject') {
    ...
    try {
      await sendSms(application.phone,
        `Hi ${application.name.split(' ')[0]} — thanks for applying to WebHustle. We can't move forward this time. Your $5 deposit has been refunded automatically (5–10 business days). Best of luck!`)
    } catch { /* ignore */ }
