...
// Default = 'agents' (original recruitment landing — pre-10DLC state).
// To switch to the B2B-clean landing for a future 10DLC review, set
// NEXT_PUBLIC_LANDING_MODE=b2b in Vercel env vars (no code change needed).
