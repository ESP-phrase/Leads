...
// Default = 'b2b' (clean landing) for 10DLC carrier review.
// After approval, set NEXT_PUBLIC_LANDING_MODE=agents to flip back to the
// agent-recruitment landing without redeploying code.
